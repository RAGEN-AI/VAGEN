...
class NavigationEnv(BaseEnv):
    ...
    def step(self, action_str: str):
        ...
        metrics['action_is_effective'] = curr_pos["x"] != prev_pos["x"] or curr_pos["z"] != prev_pos["z"]
...
if __name__ == "__main__":
    ...
    while not done:
        ...
        print(obs["obs_str"])
        print(f"Success: {info['metrics']['success']}, Action effective: {info['metrics']['action_is_effective']}")
