...
python -m vagen.env_new.create_dataset \
    --yaml_path navigation_dataset.yaml \
    --force-gen
...
python3 -m vagen.trainer.main_ppo \
    ...
    trainer.experiment_name='debug_navigation_grpo' \
    ...
    2>&1 | tee logs/debug_navigation_grpo.log
