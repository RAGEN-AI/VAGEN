...
from vagen.env.eb_alfred.gen.utils.py_util import remove_spaces_and_lower
from vagen.env.eb_alfred.gen.utils.game_util import sample_templated_task_desc_from_traj_data
